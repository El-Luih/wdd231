    ...
    */
    displayInfo(membershipLevel, infoContainerID) {
        ...
        if (membershipLevel === 1) {
            ...
            <li>🎟️ Invitations to bi-monthly networking events</li>
            ...
            <li>🛠️ Discounted vendor services via Chamber partners</li>
            ...
            <li>🎙️ Featured promotion in Chamber communications (1 spotlight/year)</li>
            ...
            <li>🏛️ Eligibility for leadership roles in Chamber committees</li>
